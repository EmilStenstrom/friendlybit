...
- comment_ID: '36739'
  ...
  comment_content: Unless you have already, you should look in to ↵http://sass-lang.com/tutorial.html↵↵It's
    a helper that supports nested css, variables etc, it works seemlessly and ofc.
    wont effect performance.↵↵I LOVE the work you're doing on kundo btw!↵↵Kristoffer,
    resihop
